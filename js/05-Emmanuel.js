...
function setupDatGui(){
    ...
    control = new function(){
      ...
      shape.ellipse(0,  0,            // ax, aY
        ...
        extrusionSettings.bevelSize=control.size;
        extrusionSettings.bevelThickness=control.thick;
    ...
    meshes.position.y=10;
        ...
        cyn1.rotation.z=15;
            wheel=new THREE.Object3D();
            wheel.add(meshes,meshed,cyn,cyn1)
            wheel.rotation.y=Math.PI/2;
            wheel.position.x=control.x;
            wheel.position.y=control.y;
            wheel.position.z=control.z;
    ...
    cyn2.rotation.z=33.5;
            wheel=new THREE.Object3D();
            wheel.add(meshes,meshed,cyn,cyn1,cyn2)
            wheel.rotation.y=Math.PI/2;
            wheel.position.x=control.x;
            wheel.position.y=control.y;
            wheel.position.z=control.z;
    ...
    cyn3.position.z=1;
            wheel=new THREE.Object3D();
            wheel.add(meshes,meshed,cyn,cyn1,cyn2,cyn3)
            wheel.rotation.y=Math.PI/2;
            wheel.position.x=control.x;
            wheel.position.y=control.y;
            wheel.position.z=control.z;
    ...
    cyn5.position.z=1;
            wheel=new THREE.Object3D();
            wheel.add(meshes,meshed,cyn,cyn1,cyn2,cyn3,cyn4,cyn5)
            wheel.rotation.y=Math.PI/2;
            wheel.position.x=control.x;
            wheel.position.y=control.y;
            wheel.position.z=control.z;
    ...
    let cynSphere6=new THREE.CylinderGeometry(0.5, 0.5, 9, 3);
        ...
        cyn7.position.z=1;
            wheel=new THREE.Object3D();
            wheel.add(meshes,meshed,cyn,cyn1,cyn2,cyn3,cyn4,cyn5,cyn6,cyn7)
            wheel.rotation.y=Math.PI/2;
            scene.add(wheel);
        }
    ...
    let cynSphere6=new THREE.CylinderGeometry(0.5, 0.5, 9, 3);
        ...
        cyn9.position.z=1;
            wheel=new THREE.Object3D();
            wheel.add(meshes,meshed,cyn,cyn1,cyn2,cyn3,cyn4,cyn5,cyn6,cyn7,cyn9)
            wheel.rotation.y=Math.PI/2;
            wheel.position.x=control.x;
            wheel.position.y=control.y;
            wheel.position.z=control.z;
    ...
    gui.add(control,'x').min(-15).max(15).step(1).name("x");
    gui.add(control,'y').min(-15).max(15).step(1).name("y");
    gui.add(control,'z').min(-15).max(15).step(1).name("z");
    gui.add(control,'size').min(0).max(5).step(1).name("size");
    gui.add(control,'thick').min(0).max(5).step(1).name("rim_thikness");
